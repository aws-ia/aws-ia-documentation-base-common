...
:doctitle: {partner-product-name} on the AWS Cloud - CDK
:!toc:
[.text-left]
...
== Costs and licenses
ifndef::production_build[]
_**This portion of the deployment guide is located at `docs/{guideroot}/{specificdir}/licenses.adoc`**_
[.preview_mode]
|===
a|
endif::production_build[]
...
== Architecture
ifndef::production_build[]
_**This portion of the deployment guide is located at `docs/{guideroot}/{specificdir}/architecture.adoc`**_
[.preview_mode]
|===
a|
endif::production_build[]
...
== Deployment options
ifndef::production_build[]
_**This portion of the deployment guide is located at `docs/{guideroot}/{specificdir}/deployment_options.adoc`**_
[.preview_mode]
|===
a|
endif::production_build[]
...
== Deployment steps
include::../../{includedir}/deployment_steps_cdk.adoc[]
...
== Troubleshooting
ifndef::production_build[]
_**This portion of the deployment guide is located at `docs/{guideroot}/{specificdir}/troubleshooting.adoc`**_
[.preview_mode]
|===
a|
endif::production_build[]
